...
- Synchronized the version roadmap and release documentation after the stable `1.0.0` publication.
...
- Added API surface verification for built ESM artifacts and package exports.
- Added security policy, upgrade guide and explicit support matrix.
- Added SBOM/provenance-compatible release commands and a security audit script.

### Changed

- Prepared the 1.0.0 release-candidate gate with documented compatibility, browser and ownership policies.
